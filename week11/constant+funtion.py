...
from keypad2 import numPadList, operatorList, constantList, functionList, constantResult
...
class Calculator(QWidget):
    ...
    def buttonClicked(self):
        ...
        if key == '=':
            ...
            self.display.setText(self.display.text() + constantResult[keyIndex])

        elif key in functionList:
            n = eval(self.display.text())
            functionResult = [ calcFunctions.factorial(n), calcFunctions.decToBin(n),
