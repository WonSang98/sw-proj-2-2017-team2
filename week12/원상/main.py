...
from keypad import numPadList, operatorList, constantList, functionList, constantValue, number, operator
...
class Calculator(QWidget):
    ...
    def buttonClicked(self):
        ...
        if key == '=':
            ...
            self.display.setText(self.display.text() + constantValue[constantList.index(key)])
            ...
            if len(temp) == 0:
                ...
                if temp[-1] in operator:
                    if key in number:
                        ...
                        pass
                elif temp[-1] in number and self.temp_key == '=' and key in number:
                    key = '='
                    pass

                elif temp[-1] in number and key == '(':
                    pass

                elif temp[-1] in operatorList and key == ')':
                    pass
